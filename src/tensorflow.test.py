...
#read data from csv
train_data = pd.read_csv("/notebooks/masters-project/src/iris_training.csv", names=['f1', 'f2', 'f3', 'f4', 'f5'])
test_data = pd.read_csv("/notebooks/masters-project/src/iris_test.csv", names=['f1', 'f2', 'f3', 'f4', 'f5'])
